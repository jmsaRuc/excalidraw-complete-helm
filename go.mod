...
require (
	...
	github.com/zishang520/socket.io/adapters/redis/v3 v3.0.0-rc.10
...
require (
	...
	github.com/zishang520/socket.io/adapters/adapter/v3 v3.0.0-rc.10 // indirect
	github.com/zishang520/socket.io/parsers/engine/v3 v3.0.0-rc.10 // indirect
	github.com/zishang520/socket.io/parsers/socket/v3 v3.0.0-rc.10 // indirect
